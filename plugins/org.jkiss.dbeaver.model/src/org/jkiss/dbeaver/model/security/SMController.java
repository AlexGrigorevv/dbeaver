...
public interface SMController<USER extends SMUser, ROLE extends SMRole> extends SMAuthCredentialsManager {
    ...
    SMAuthInfo authenticate(@NotNull String appSessionId, @Nullable String userId, @NotNull Map<String, Object> parameters, @NotNull SMSessionType sessionType) throws DBCException;
